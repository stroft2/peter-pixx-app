...
export const GenerateImageIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
        <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
    </svg>
);

export const GenerateVideoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
...
export const PreciseRetouchingIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h.008v.008H3.75V12Zm0-4.5h.008v.008H3.75V7.5Zm0 9h.008v.008H3.75v-.008Zm16.5 0h.008v.008h-.008v-.008Zm0-9h.008v.008h-.008V7.5Z" />
    </svg>
);

export const CreativeFiltersIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.47 2.118 2.25 2.25 0 0 0-2.118 2.47 3 3 0 0 0 1.128 5.78 3 3 0 0 0 5.78-1.128 2.25 2.25 0 0 1 2.47-2.118 2.25 2.25 0 0 0 2.118-2.47 3 3 0 0 0-1.128-5.78Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a2.121 2.121 0 0 0 3.15-1.791 2.121 2.121 0 0 1 1.791-3.15 2.12 2.12 0 0 0 1.791-3.15c-.244-.75-.85-1.356-1.6-1.6a2.121 2.121 0 0 0-3.15 1.791 2.121 2.121 0 0 1-1.791 3.15 2.12 2.12 0 0 0-1.791 3.15c.244.75.85 1.356 1.6 1.6Z" />
    </svg>
);
...
export const ColorBalanceIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const AnalyzeFrameIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
